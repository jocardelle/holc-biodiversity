...
Redlining refers to a practice by the Home Owners' Loan Corporation(HOLC) that dates back to the 1930's. The HOLC would rate neighborhoods (A, B, C, or D) by "residential security" in various American cities. In this analysis we will explore the effects of redlining on health, economy, and environment today.
...
kable(birds_count_area, caption = "Bird observations per square kilometer in each HOLC grade")
